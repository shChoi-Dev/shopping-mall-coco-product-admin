...
import '../css/SignupTermsPopup.css';

// 회원가입 약관 상세 내용을 모달로 보여주는 컴포넌트
function SignupTermsPopup({ type, onClose }) {
  ...
  return (
    <div className="signup-terms-popup-overlay" onClick={onClose}>
      <div className="signup-terms-popup-content" onClick={(e) => e.stopPropagation()}>
        <div className="signup-terms-popup-header">
          <h3>{title}</h3>
          <button onClick={onClose} className="signup-terms-popup-close">&times;</button>
        </div>

        <div className="signup-terms-popup-body">
